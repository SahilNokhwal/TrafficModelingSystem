	...
	public JPanel getDraggableFourWayPanel() {
		...
		draggableFourWayPanel = new DraggableFourWayPanel() {
			protected void paintComponent(Graphics g) {
				...
				// g.drawLine(0,
				// Math.toIntExact((Math.round(39.58*draggablePanelWidth/100))),
				// Math.toIntExact((Math.round(33.87*draggablePanelHeight/100))),
				// Math.toIntExact((Math.round(39.58*draggablePanelWidth/100))));
				// g.drawLine(0,
				// Math.toIntExact((Math.round(60.41*draggablePanelWidth/100))),
				// Math.toIntExact((Math.round(33.87*draggablePanelHeight/100))),
				// Math.toIntExact((Math.round(60.41*draggablePanelWidth/100))));
				// g.drawLine(Math.toIntExact((Math.round(66.12*draggablePanelWidth/100))),
				// Math.toIntExact((Math.round(60.41*draggablePanelWidth/100))),
				// Math.toIntExact((Math.round(33.87*draggablePanelHeight/100))),
				// Math.toIntExact((Math.round(60.41*draggablePanelWidth/100))));
				// g.drawLine(0,
