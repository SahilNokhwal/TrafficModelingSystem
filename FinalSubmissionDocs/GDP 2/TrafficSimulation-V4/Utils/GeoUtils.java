...
public abstract class GeoUtils {
    ...
    public static double getDistance(Line2D line) {
    	return getDistance(line.getP1(),line.getP2());
    }
    public static Point2D getMidPoint(Point2D p1, Point2D p2) {
    	return getMidPoint(p1.getX(),p2.getX(),p1.getY(),p2.getY());
    }
    ...
    public static double Percent(double value, double perc) {
    	return value + ((value / 100) * perc);
    }
}
